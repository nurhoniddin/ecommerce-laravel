				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{ asset('/') }}"><img src="/images/frontend_images/home/logo.png" alt="" /></a>
						</div>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							...
							<button type="submit" style="border: 0px; height: 33px; margin-left: -3px; padding-bottom: 3px;">Go</button>
							</form>
						</div>
					</div>
				</div>
